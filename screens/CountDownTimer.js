...
class CountDownTimer extends Component {
  ...
  start = () => {
    this.setState(state => ({
      remainingSeconds: state.selectedMinutes * 60 + state.selectedSeconds,
      isRunning: true,
    }));
    ...
    return (
      <>
        <View style={styles.pickerContainer}>
          <WheelPicker
            selectedItem={this.state.selectedMinutes}
          ...
          <WheelPicker
            selectedItem={this.state.selectedSeconds}
            selectedItemTextColor={'white'}
            selectedItemTextSize={20}
            hideIndicator
    ...
    return (
      <NativeBaseProvider>
        ...
        <Fab
          ...
          right={19}
          icon={
            <ArrowForwardIcon name="next" type="AntDesign" color="#89AAFF" />
          }
          onPress={() =>
            navigate('Count Down Timer Next', {
